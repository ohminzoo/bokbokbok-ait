...
export declare const defaultOnLayoutThreshold = 300;
export declare const defaultOnScrollThreshold = 100;
/**
 * @kind class
...
declare class IntersectionObserver {
    ...
    protected createOnScrollHandler(): import("es-toolkit").ThrottledFunction<() => void>;
