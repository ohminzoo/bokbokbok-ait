...
import * as babel$1 from "@babel/core";
...
interface BuildConfig {
  ...
  INTERNAL__esbuildOptions?: (context: {
    platform: string;
    dev: boolean;
  }, options: esbuild.BuildOptions) => Promise<esbuild.BuildOptions> | esbuild.BuildOptions;
  /**
   * Finalize babel options dynamically
   */
  INTERNAL__babelOptions?: (context: {
    platform: string;
    dev: boolean;
  }, options: babel.TransformOptions) => Promise<babel.TransformOptions> | babel.TransformOptions;
  /**
   * Finalize swc options dynamically
   */
  INTERNAL__swcOptions?: (context: {
    platform: string;
    dev: boolean;
  }, options: swc.Options) => Promise<swc.Options> | swc.Options;
}
...
interface AdditionalMetroConfig extends MetroConfig {
  ...
  babelConfig?: babel$1.TransformOptions;
